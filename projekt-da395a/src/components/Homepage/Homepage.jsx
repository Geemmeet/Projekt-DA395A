        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
              ...
              <div href="#" className="inline-flex items-center justify-center w-1/3 px-5 py-3 text-base font-medium text-center ">
                <Select id="countries" className="w-full">
                  <option value="none" selected disabled hidden>Choose your diet..</option>
